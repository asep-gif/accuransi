...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            cv_tagline: "Featured Tool",
            cv_title: "CV Builder by Accuransi",
            cv_desc: "Create a professional and modern CV in minutes. Our intuitive tool helps you stand out with customizable templates and easy-to-use features. Free, no watermark.",
            cv_button: "Create Your CV Now",
        ...
        id: {
            ...
            cv_tagline: "Alat Unggulan",
            cv_title: "CV Builder oleh Accuransi",
            cv_desc: "Buat CV profesional dan modern dalam hitungan menit. Alat kami yang intuitif membantu Anda tampil beda dengan templat yang dapat disesuaikan dan fitur yang mudah digunakan. Gratis, tanpa watermark.",
            cv_button: "Buat CV Anda Sekarang",
